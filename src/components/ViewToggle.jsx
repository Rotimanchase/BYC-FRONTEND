  ...
  return (
    <div className="flex space-x-2">
      <button onClick={() => setActiveView('list')}
        className={`p-2 rounded-md border ${ activeView === 'list' ? 'bg-gray-200 border-gray-400' : 'bg-white border-gray-300 hover:bg-gray-100' }`}>

        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30"  height="30" fill="#5F6368">
      ...
      <button onClick={() => setActiveView('grid')} className={`p-2 rounded-md border ${ activeView === 'grid' ? 'bg-gray-200 border-gray-400' : 'bg-white border-gray-300 hover:bg-gray-100' }`}>
