    ...
    try {
      ...
      if (response.data.success) {
        ...
        try {
          ...
          toast.error('Failed to clear cart after payment. Please check your cart.', {
            id: 'cart-error'
          });
        }
      ...
      <div className="text-center max-w-2xl mx-auto p-6">
        {verified ? (
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 text-lg mb-6"> Thank you for your order. Your payment has been processed successfully. </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button onClick={handleViewOrders} className="px-8 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition font-medium">
                View My Orders
              </button>
              <button onClick={handleContinueShopping} className="px-8 py-3 border border-red-600 text-red-600 rounded-lg hover:bg-red-50 transition font-medium">
                Continue Shopping
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={() => navigate('/contact')} className="px-8 py-3 border border-red-600 text-red-600 rounded-lg hover:bg-red-50 transition font-medium">
                Contact Support
              </button>
            </div>
          </div>
